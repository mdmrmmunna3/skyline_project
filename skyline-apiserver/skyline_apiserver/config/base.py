# ফাইল: /mnt/c/xampp/htdocs/PCL_Project/OpneStack/skyline-console/skyline-apiserver/skyline_apiserver/config/base.py
...
class Configuration:
    ...
    def setup(self, project: str, env: Dict[str, str]) -> None:
        # --- এই দুটি লাইনে কনফিগারেশন পাথ হার্ডকোড করে দেওয়া হলো (ফিক্স) ---
        config_file_path = '/mnt/c/xampp/htdocs/PCL_Project/OpenStack/skyline-console/skyline-apiserver/etc/skyline.yaml'
        config_dir_path = PurePath(config_file_path).parent.as_posix() 
        # --- ফিক্স শেষ ---
